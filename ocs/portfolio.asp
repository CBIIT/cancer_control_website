...
<html>
<head>
<title>DCCPS: OCS: Cancer Control Research</title>
...
<table width="752" border="0" cellpadding="0" cellspacing="0">
 ...
 border="0"></td>
			  ...
			  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="1">
				  ...
				  <tr valign="top">
				    <td><a href="portfolio.asp" class="navigation-dark-gray-link"><strong>Active Research Grant Portfolio</strong></a></td>
				  </tr>
				  <tr valign="top">
				    <td><a href="portfolio_archive.asp" class="navigation-dark-gray-link">Previously funded grants</a></td>
				  </tr>
				  <tr valign="top">
 ...
 border="0"></td>
		...
		<p>In additon to the grants listed below, OCS funds:</p>
            <ul>
              <li>5 research supplements for <a href="underrepresented/">underrepresented minorities</a>
            </ul>

		<p>&nbsp;</p>

            <!-- #include virtual="/grants/utility.asp" -->
            <% DisplayGrants "OCS", "OAD", "ACTIVE" %></td>
	  </tr>
	</table>
		</td>
	  </tr>
