...
<!-- InstanceBeginEditable name="doctitle" -->
    <title>Health Disparities Research | DCCPS/NCI/NIH</title>
    <!-- InstanceEndEditable -->
...
<![endif]-->
  ...
  <body>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-NMGZRC" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
		...
		<div class="col-lg-12">
			...
			<nav id="navbar-responsive" class="navbar-collapse collapse" role="navigation" aria-expanded="false">
				<div class="form-group dccps-search">
					<form class="navbar-form" method="get" action="https://barney2.cit.nih.gov/search" name="search">
						...
						<input id="searchbox" type="text" name="q" size="15" maxlength="255" class="form-control" placeholder="SEARCH">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Program Areas <span class="sr-only">Open Dropdown</span><b class="caret"></b></a>
						<ul class="dropdown-menu">
							...
							<li><a href="../IS/">Implemention Science</a></li>
							<li><a href="https://surveillance.cancer.gov/">Surveillance</a></li>
							<li><a href="../ocs/">Survivorship</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Research Portfolios <span class="sr-only">Open Dropdown</span><b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Funding Opportunities <span class="sr-only">Open Dropdown</span><b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li class="landing-page-link"><a href="../funding.html">Funding Opportunities <span class="sr-only">Landing Page</span></a></li>
							<li><a href="../funding_apply.html">Apply for Cancer Control Grants</a></li>
							<li><a href="../funding_career.html">Training &amp; Career Development</a></li>
							<li><a href="../funding_info.html">Application Submission &amp; Review</a></li>
							<li><a href="../policy_info.html">Grant Policies</a></li>
							<li><a href="../new_grantees/index.html">Resources &amp; Opportunities for New Grantees</a></li>
							<li><a href="../funding_archive.html">Archive of Funding Opportunities</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Publications &amp; Data <span class="sr-only">Open Dropdown</span><b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="active dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Research Emphasis <span class="sr-only">Open Dropdown</span><b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li class="landing-page-link"><a href="./index.html">Research Emphasis <span class="sr-only">Landing Page</span></a></li>
							<li><a href="./energy-balance.html">Energy Balance</a></li>
							<li class="active"><a href="./health-disparities.html">Health Disparities</a></li>
							<li><a href="./quality-of-care.html">Care Coordination</a></li>
							<li><a href="./patterns-of-care.html">Patterns of Care</a></li>
							<li><a href="./precision-medicine.html">Precision Medicine &amp; Population Health</a></li>
							<li><a href="./lynch-syndrome.html">Hereditary Cancer Syndromes</a></li>
						</ul>
					</li>
					<!-- InstanceEndEditable -->
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">About DCCPS <span class="sr-only">Open Dropdown</span><b class="caret"></b></a>
						<ul class="dropdown-menu">
...
<div class="crosscuttingareas-band"></div>
<div class="page-title">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<!-- InstanceBeginEditable name="Header" -->
                 <h1>Health Disparities Research Grants</h1>
                <!-- InstanceEndEditable -->
			</div> <!-- /.col-lg-12 -->
		</div> <!-- close /.row -->
	</div> <!-- close /.container -->
	...
	<div class="row">
		<div class="col-lg-12">
			<!-- InstanceBeginEditable name="Breadcrumbs" -->
               <ol class="breadcrumb">
                    <li><a href="../index.html">Home</a></li>
                    <li><a href="./index.html">Research Emphasis</a></li>
                    <li><a href="./health-disparities.html">Health Disparities Research</a></li>
                    <li>Health Disparities Research Grants</li>
                 </ol>
               <!-- InstanceEndEditable -->
		</div> <!-- /.col-lg-12 -->
	</div> <!-- close /.row -->
		...
		<div class="col-md-8 col-md-offset-1">
			<div class="row links">
				<div class="col-md-4">
					<ul class="list-unstyled dccps-links">
						...
						<li><a href="../current_research.html">Research Portfolio</a></li>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<p class="update"><span class="bold">Last Updated:</span> <!-- InstanceBeginEditable name="Last Updated" -->January 10, 2011<!-- InstanceEndEditable --></p>
				</div> <!-- /.col-lg-12 -->
			</div> <!-- /.row -->
