<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Subscribe-TUS-CPS.aspx.vb" Inherits="brp_e_newsletter_Subscribe" %>
...
<style type="text/css">
    ...
    .homepage .form-container #frm_SubScribe .form-group input#TXT_Email, .homepage .form-container #frm_SubScribe .form-group input#txtemailTerms
    {
    margin: 0 0 20px;
    }
    .alert { 
