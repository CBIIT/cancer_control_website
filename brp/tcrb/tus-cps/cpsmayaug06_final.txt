/********************************************************************************/;
/* Program: cpsmayaug06.sas                                                     */;
/*    Date: June 2011                                                           */;
/*                                                                              */;
/* Purpose: SAS program to create permanent SAS data dets from the 2006 survey  */;
/*          data.  The program creates one permanent data set for each survey   */;
/*          (May, August).                                                      */;
/*                                                                              */;
...
/*                                                                              */;
/********************************************************************************/;
Filename CPSMAY06 "data\cpsmay06.dat" lrecl=1315;
Filename CPSAUG06 "data\cpsaug06.dat" lrecl=1315;
Libname  CPS "data\.";

%Macro TUSCPS06(Survey);
  Data CPS.CPS&Survey;
    ...
    Label HRHHID   = "Household identifier (part 1)"
          ...
          HURESPLI = "Line number of current respondent"
          ...
          HENXTP   = "Line number of person being interviewed"
          HENXTPR3 = "Is this self or proxy?"
