var terms = [
	{
		...
		'definition': '<p><strong>Naomi  Eisenberger, Ph.D., and Julienne Bower, Ph.D., University of California, Los  Angeles </strong> </p><p>  Based on the white paper referenced above, this project aims to identify  and pilot test fMRI probe tasks that can help assess whether individual  differences in measures of experienced social support (as measured by the  Social Provisions Scale-Attachment and the UCLA Loneliness Scale) relate systematically  to individual differences in neural activity to the specialized probe tasks.  Phase I of the project will be conducted in healthy volunteer subjects. </p>',
