<%@ Page Language="VB" AutoEventWireup="false" CodeFile="poster.aspx.vb" Inherits="CAA_Testing_testReg" %>
...
<meta name="author" content="National Cancer Institute, Division of Cancer Control and Population Science">
    <title>Submit a Poster Abstract | Cancer and Accelerated Aging: Advancing Research for Healthier Survivors | DCCPS/NCI/NIH</title>
	    ...
	    <div class="row">
		    <div class="col-lg-12">
                  <ol class="breadcrumb">
                        ...
                        <li>Submit a Poster Abstract</li>
                  </ol>
		    </div> <!-- /.col-lg-12 -->
	    </div> <!-- /.row -->
	</div> <!-- /.container -->
        ...
        <div class="col-md-12">
            ...
            <div class="row">
				<div class="col-sm-12">
					...
					<p><strong>Abstract Submission Deadline: 11:59 PM ET, Friday, January 10, 2020</strong></p>
					<p>Poster abstracts are being solicited to highlight the methods and findings of efforts to define and describe the catchment area populations of U.S. cancer centers. Submissions are not limited to NCI-designated cancer centers or P30 administrative supplement awardees. Grantees who were awarded 2018 P30 administrative supplements for catchment area assessments do not need to submit an abstract for their oral presentation/main study, but junior investigators and co-investigators on those supplement grants are welcome to submit poster abstracts that highlight other uses of the survey data. Round 1 (2016-2017) P30 supplement grantees are encouraged to submit posters as a follow up to their presentations given at the 2018 cancer center catchment area grantee meeting at Albert Einstein Cancer Center in New York. Community groups and organizations who are partnering with cancer centers to use the data to inform population health activities are also welcome to submit poster abstracts to highlight their work.</p>
					<p>Please check the accuracy of all information before  clicking the submit button.</p>
            ...
            <div class="row">
					<div class="col-md-12">
						<asp:Label ID="Label1" runat="server" AssociatedControlID="TXT_PosterTitle" Text="Poster Title *"></asp:Label>
					  <asp:TextBox ID="TXT_PosterTitle" class="form-control" runat="server"></asp:TextBox> 
						<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TXT_PosterTitle" Display="Dynamic" ErrorMessage="Please enter a Poster Title." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					</div> 
            </div>
            <div class="row">
					<div class="col-md-12">
						<asp:Label ID="Label2" runat="server" AssociatedControlID="TXT_AuthorList" Text="Full Author List * (please include full name for each author, separated by a comma)"></asp:Label>
					  <asp:TextBox ID="TXT_AuthorList" class="form-control" runat="server"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TXT_AuthorList" Display="Dynamic" ErrorMessage="Please enter the Full Author List." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					</div> 
            </div>
            <div class="spacer-20"></div>
            <div class="row">
                    <div class="col-md-6">
						<asp:Label ID="Label16" runat="server" AssociatedControlID="TXT_PresentingAuthor" Text="Presenting Author *"></asp:Label>
					  <asp:TextBox ID="TXT_PresentingAuthor" class="form-control" runat="server"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TXT_PresentingAuthor" Display="Dynamic" ErrorMessage="Please enter a Presenting Author." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					</div>
					<div class="col-md-6">
						<asp:Label ID="Label3" runat="server" AssociatedControlID="TXT_PresentingAuthorEmail" Text="Presenting Author Email *"></asp:Label>
					  <asp:TextBox ID="TXT_PresentingAuthorEmail" class="form-control" runat="server"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TXT_PresentingAuthorEmail" Display="Dynamic" ErrorMessage="Please enter an email address." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TXT_PresentingAuthorEmail" Display="Dynamic" ErrorMessage="Please enter a valid email address." CssClass="alert alert-danger" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                    </div> 
            </div>
            <div class="row">
					<div class="col-md-6">
						<asp:Label ID="Label4" runat="server" AssociatedControlID="DDList_PresentingAuthorInstitution" Text="Presenting Author institutional and/or cancer center affiliation *"></asp:Label>
					  <asp:DropDownList ID="DDList_PresentingAuthorInstitution" runat="server" Width="100%">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="DDList_PresentingAuthorInstitution" Display="Dynamic" ErrorMessage="Please enter a Presenting Author institutional and/or cancer center affiliation." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
                        <div id="otherPresentingAuthor">
                            <asp:Label ID="Label5" runat="server" AssociatedControlID="TXT_PresentingAuthorInstitution_Other" Text="Other, please specify"></asp:Label>
					        <asp:TextBox ID="TXT_PresentingAuthorInstitution_Other" class="form-control" runat="server"></asp:TextBox>
                        </div>					
                    </div> 
            </div>
            <div class="spacer-20"></div>
            <div class="row">
					<div class="col-md-6">
						<asp:Label ID="Label10" runat="server" AssociatedControlID="TXT_CorrespondingAuthor" Text="Corresponding Author (if different from presenting author)"></asp:Label>
					  <asp:TextBox ID="TXT_CorrespondingAuthor" class="form-control" runat="server"></asp:TextBox>
					</div> 	
					<div class="col-md-6">
						<asp:Label ID="Label11" runat="server" AssociatedControlID="TXT_CorrespondingAuthorEmail" Text="Corresponding Author Email"></asp:Label>
					  <asp:TextBox ID="TXT_CorrespondingAuthorEmail" class="form-control" runat="server"></asp:TextBox> 
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TXT_CorrespondingAuthorEmail" Display="Dynamic" ErrorMessage="Please enter a valid email address." CssClass="alert alert-danger" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
					</div> 
            </div>
            <div class="row">
					<div class="col-md-6">
						<asp:Label ID="Label7" runat="server" AssociatedControlID="DDList_CorrespondingAuthorInstitution" Text="Corresponding Author institutional and/or cancer center affiliation"></asp:Label>
					  <asp:DropDownList ID="DDList_CorrespondingAuthorInstitution" runat="server" Width="100%">
                             <asp:ListItem Text="--Select--" Value="" />
                             <asp:ListItem Text="Abramson Cancer Center" Value="Abramson Cancer Center" />
                             <asp:ListItem Text="Albert Einstein Cancer Center" Value="Albert Einstein Cancer Center" />
                             <asp:ListItem Text="Alvin J. Siteman Cancer Center" Value="Alvin J. Siteman Cancer Center" />
                        ...
                        <div id="otherCorrespondingAuthor">
                            <asp:Label ID="Label6" runat="server" AssociatedControlID="TXT_CorrespondingAuthorInstitution_Other" Text="Other, please specify"></asp:Label>
					        <asp:TextBox ID="TXT_CorrespondingAuthorInstitution_Other" class="form-control" runat="server"></asp:TextBox>
                        </div>
					</div>
            </div>
            <div class="row">
                    <div class="col-md-12">
						<asp:Label ID="Label8" runat="server" AssociatedControlID="TXT_Abstract" Text="Abstract *"></asp:Label>
					  <asp:TextBox ID="TXT_Abstract" class="form-control" runat="server" TextMode="MultiLine" Rows="5"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TXT_Abstract" Display="Dynamic" ErrorMessage="Please enter an abstract." CssClass="alert alert-danger" ValidationExpression="^(\(?\s*\d{3}\s*[\)\-\.]?\s*)?[2-9]\d{2}\s*[\-\.]\s*\d{4}$"></asp:RequiredFieldValidator>
                        <div id="result">
                            <span id="wordCount">300</span> word(s) remaining.
                        </div>
						<asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="TXT_Abstract" ID="RegularExpressionValidator7" ValidationExpression="^\s*(\S+\s+|\S+$){0,300}$" runat="server" ErrorMessage="Maximum 300 words allowed." CssClass="alert alert-danger"></asp:RegularExpressionValidator>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<p class="update"><span class="bold">Last Updated:</span>October 18, 2019</p>
		</div> <!-- /.col-lg-12 -->
	</div> <!-- /.row -->
</div> <!-- /.container -->
</div> <!-- /.lightgray-row -->
...
<script type="text/javascript">
     counter = function() {
        ...
        $('#wordCount').html(300-wordCount);
    };
    $(document).ready(function() {
        $('#TXT_Abstract').change(counter);
        $('#TXT_Abstract').keydown(counter);
        $('#TXT_Abstract').keypress(counter);
        $('#TXT_Abstract').keyup(counter);
        $('#TXT_Abstract').blur(counter);
        $('#TXT_Abstract').focus(counter);
        $('#otherPresentingAuthor').css("display", "none");
        $('#otherCorrespondingAuthor').css("display", "none");
    });
    $('#DDList_PresentingAuthorInstitution').change(function() {
        if (this.value == 'Other') {
            $('#otherPresentingAuthor').css("display", "block");
        }
        else {
            $('#otherPresentingAuthor').css("display", "none");
        }
    });
    $('#DDList_CorrespondingAuthorInstitution').change(function() {
        if (this.value == 'Other') {
            $('#otherCorrespondingAuthor').css("display", "block");
        }
        else {
            $('#otherCorrespondingAuthor').css("display", "none");
        }
