...
<li class="dropdown">
    ...
    <form id="form1" runat="server">
       ...
       <asp:Label ID="Label10" runat="server" AssociatedControlID="TXT_Phone" Text="Phone:"></asp:Label> <asp:TextBox ID="TXT_Phone" runat="server"></asp:TextBox><br />
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.doc|.docx|.pdf)$" ControlToValidate="UP_PersonalStatement_File" runat="server" ForeColor="Red" ErrorMessage="Please select a valid Word or PDF File file." Display="Dynamic" CssClass="alert" /> <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="UP_PersonalStatement_File" ErrorMessage="File size should not be greater than 1 MB." OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator><br />
