				...
				<ul class="nav navbar-nav">
                            ...
                            <li class="active dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="https://cyberseminar-stage.icfwebservices.com/implementationscience/">Webinars</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
...
<!-- intro area -->	
	<div class="row">
		<div class="col-md-9 col-md-push-3">                 
			<p class="intro">The 2018 application period is closed. Please come back in early 2019 to apply for the next training. 2018 applicants will be notified of their acceptance status by March 7, 2018. </p>
			...
			<form id="form1" runat="server">
				<!--<div class="row">
					...
					<div class="col-md-3">	
						<asp:Label ID="Label8" runat="server" AssociatedControlID="TXT_State" Text="State"></asp:Label>
					  <asp:TextBox ID="TXT_State" class="form-control" runat="server"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TXT_State" Display="Dynamic" ErrorMessage="Please enter a state." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					</div> 	
					<div class="col-md-3">	
						<asp:Label ID="Label9" runat="server" AssociatedControlID="TXT_Zip" Text="Zip Code"></asp:Label>
					  <asp:TextBox ID="TXT_Zip" class="form-control" runat="server"></asp:TextBox>
						...
						<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TXT_Zip" Display="Dynamic" ErrorMessage="Please enter a valid 5-digit zip code." CssClass="alert alert-danger" ValidationExpression="^\d{5}$"></asp:RegularExpressionValidator>
					</div> 	
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
					  ...
					  <asp:DropDownList ID="TXT_AreYouHispanic" class="form-control" runat="server">
							<asp:ListItem disabled="disabled" selected="selected" hidden="hidden">- Select One -</asp:ListItem>
							<asp:ListItem>No</asp:ListItem>
							<asp:ListItem>Yes</asp:ListItem>
						</asp:DropDownList>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="TXT_AreYouHispanic" Display="Dynamic" ErrorMessage="Please select an answer." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					  ...
					  <asp:DropDownList ID="TXT_Gender" class="form-control" runat="server">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="TXT_Gender" Display="Dynamic" ErrorMessage="Please enter a gender." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
					</div> 
				</div> 
				<hr>
				<div class="row">
					<div class="col-md-12">
					  ...
					  <asp:DropDownList ID="TXT_InvestigatorLevel" class="form-control" runat="server">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TXT_InvestigatorLevel" Display="Dynamic" ErrorMessage="Please select an investigator level." CssClass="alert alert-danger"></asp:RequiredFieldValidator>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<p class="update"><span class="bold">Last Updated:</span> February 9, 2018</p>
		</div> <!-- /.col-lg-12 -->
	</div> 
</div> <!-- /.container -->
</div> <!-- /.lightgray-row -->
	...
	<div class="row links">
		...
		<div class="col-md-3">
			<ul class="list-unstyled dccps-links">
				<li><h2>DCCPS</h2></li>
				<li><a href="https://www.cancercontrol.cancer.gov/">DCCPS Home</a></li>
				<li><a href="https://www.cancercontrol.cancer.gov/program_areas.html">Program Areas</a></li> 
				<li><a href="https://www.cancercontrol.cancer.gov/current_research.html">Research Portfolios</a></li>
				<li><a href="https://www.cancercontrol.cancer.gov/funding.html">Funding Opportunities</a></li>
				<li><a href="https://www.cancercontrol.cancer.gov/cancer_resources.html">Publications &amp; Data</a></li>
				<li><a href="https://www.cancercontrol.cancer.gov/research-emphasis/index.html">Research Emphasis</a></li> 
				<li><a href="https://www.cancercontrol.cancer.gov/od/index.html">About DCCPS</a></li> 
			</ul>
		</div> 
		<div class="col-md-3">
