<%@ Page Language="VB" AutoEventWireup="false" CodeFile="thank-you.aspx.vb" Inherits="IS_webinars" %>
...
<head>
    ...
    <title>Thank You for Your Registration | Webinars | IS | DCCPS/NCI/NIH</title>
    ...
    <style type="text/css">
        .addtoOutlookButton{
            background: #ffffff url('/IS/images/outlook_calendar.png') repeat-x left 0px;
            /*background:  url('/implementationscience/img/outlook_calendar.png');*/
            border: none;
            padding: 0px;
            overflow: visible;
...
<body class="is">
    ...
    <main id="main-content" class="subpages" role="main" tabindex="-1">
        ...
        <div class="container">
	        <div class="row">
                <div class="col-md-12">
                    <p class="intro">Thank you for registering. You will receive a  confirmation email momentarily.</p>

                     <p><asp:Literal ID="litGoogle" runat="server"></asp:Literal></p>
