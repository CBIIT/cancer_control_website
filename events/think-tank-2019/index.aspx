...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
              <ol class="breadcrumb">
                    ...
                    <li><a href="index.html">Cognition and Medical Image Perception Think Tank</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
			...
			<div class="row">
				<div class="col-sm-9">
					<p><strong>Thank you for your interest in the Cognition and Medical Image Perception Think Tank meeting. Registration for this event has closed.</strong> </p>
				</div>
            </div>
			-->
			<div class="row">
				<div class="col-sm-12">
					<img src="/images/Vision-Science-Problems-in-Medical-Imaging.jpg" alt="Strategies to Prevent or Remediate Cancer- and Treatment-Associated Aging" class="img-responsive">
				</div> <!-- /.col-sm-12 -->
			</div>
            ...
            <div class="row">
				<div class="col-sm-12">
					...
					<hr>
					<p><strong>Participation in this working think tank is by  invitation only, and invitations are non-transferable. To register, complete  the form below.<br>
				  </strong></p>
            ...
            <div class="row">
                    <div class="col-md-6">
						<asp:Label ID="Label16" runat="server" AssociatedControlID="TXT_Degree" Text="Degree (e.g., MD and PhD) *"></asp:Label>
					...
					<div class="col-md-6">
						<asp:Label ID="Label3" runat="server" AssociatedControlID="TXT_Title" Text="Title (e.g., Associate Professor) *"></asp:Label>
            ...
            <div class="row">
                    <div class="col-md-6">
						<asp:Label ID="Label17" runat="server" AssociatedControlID="TXT_AA_Name" Text="Assistant's Name"></asp:Label>
					  <asp:TextBox ID="TXT_AA_Name" class="form-control" runat="server"></asp:TextBox>
					</div> 
                    <div class="col-md-6">
						<asp:Label ID="Label19" runat="server" AssociatedControlID="TXT_AA_Phone" Text="Assistant's Phone"></asp:Label>
					  <asp:TextBox ID="TXT_AA_Phone" class="form-control" runat="server"></asp:TextBox>
					</div> 
            </div>
            <div class="row">
                    <div class="col-md-6">
						<asp:Label ID="Label20" runat="server" AssociatedControlID="TXT_AA_Email" Text="Assistant's Email"></asp:Label>
					  <asp:TextBox ID="TXT_AA_Email" class="form-control" runat="server"></asp:TextBox>
						<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="TXT_AA_Email" Display="Dynamic" ErrorMessage="Please enter a valid email address." CssClass="alert alert-danger" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator><br>
					</div>
				</div> 
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        <p><b>If you have not already emailed these to us, please upload the following:</b></p>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-6">
						<asp:Label ID="Label18" runat="server" AssociatedControlID="UP_HeadShot_File" Text="Professional Headshot (Please upload a high-resolution headshot at least 960 x 720)."></asp:Label>
						<asp:FileUpload ID="UP_HeadShot_File" class="form-control" runat="server" />
						<asp:RegularExpressionValidator ID="RegularExpressionValidator3" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.jpg|.jpeg|.png|.gif|.bmp)$" ControlToValidate="UP_HeadShot_File" runat="server" ErrorMessage="Please select a valid image file type (jpg, png, gif or bmp)." Display="Dynamic" CssClass="alert alert-danger" />
						<asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="UP_HeadShot_File" Display="Dynamic" ErrorMessage="File size should not be greater than 1 MB." CssClass="alert alert-danger" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
					</div> 
                    <div class="col-md-6">
						<asp:Label ID="Label12" runat="server" AssociatedControlID="TXT_Bio" Text="Brief bio (limit 250 words). Please cut and paste or type your bio into the space below."></asp:Label>
					    <asp:TextBox ID="TXT_Bio" class="form-control" runat="server" Rows="3" TextMode="MultiLine"></asp:TextBox>
                         <div id="result">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <asp:Label ID="Label14" runat="server" AssociatedControlID="RDList_Photo_Consent" Text="I consent to be photographed while attending the Cognition and Medical Image Perception Think Tank event. I further authorize that the photographs may be published. *"></asp:Label>
                        <asp:RadioButtonList ID="RDList_Photo_Consent" runat="server">
                            <asp:ListItem Text="Yes" Value="TRUE" />
                            <asp:ListItem Text="No" Value="FALSE" />
                        </asp:RadioButtonList>
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator14" Display="Dynamic" ControlToValidate="RDList_Photo_Consent" ErrorMessage="Please select Yes or No" CssClass="alert alert-danger"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-md-6">                            
                        <asp:Label ID="Label15" runat="server" AssociatedControlID="RDList_AttendingHappyHour" Text="Attending Scientific Networking Event (An optional happy hour/dinner after Meeting Day 1. Attendees will be responsible for their happy hour/dinner cost.) *"></asp:Label>
                        <asp:RadioButtonList ID="RDList_AttendingHappyHour" runat="server">
                            <asp:ListItem Text="Yes" Value="TRUE" />
                            <asp:ListItem Text="No" Value="FALSE" />
                        </asp:RadioButtonList>
                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5" Display="Dynamic" ControlToValidate="RDList_AttendingHappyHour" ErrorMessage="Please select Yes or No" CssClass="alert alert-danger"></asp:RequiredFieldValidator>
                        </div>
				</div>
                <hr>

                <div class="row">
                    <div class="col-md-12"><h3>Lunch Information</h3>
<p><strong><em>Attendees will be responsible for getting their own lunch at their own cost.</em></strong></p>
<p> There is a cafeteria in the NCI building on the Terrace Level (this <a href="http://www.cci115.com/">link</a> <a href="/exit_disclaimer.html" class="add-on" title="External Link"><img src="/images/Icon_External_Link.png" width="12" height="12" alt="exit disclaimer"></a> provides more information about the food available in the cafeteria). In addition, there are a number of restaurants and cafés located near NCI Shady Grove. </p>
<p> You can pre-order a lunch for the first day of the meeting (Thursday, September 12) at a cost of $13. Payment must be made at the registration desk <strong><em>with exact cash only</em></strong>.</p></div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <asp:Label ID="Label7" runat="server" AssociatedControlID="DDList_SandwichDay1" Text="Pre-ordered Lunch Choices (Will include freshly baked cookie and bag of potato chips):"></asp:Label>
                        <br>
                        <asp:DropDownList ID="DDList_SandwichDay1" runat="server" Width="100%">
                            <asp:ListItem Text="Roast Beef with Cheddar on Focaccia roll" Value="Roast Beef with Cheddar on Focaccia roll" />
                            <asp:ListItem Text="Baked Ham and Swiss on Focaccia roll" Value="Baked Ham and Swiss on Focaccia roll" />
                            <asp:ListItem Text="Turkey with American Cheese on Focaccia roll" Value="Turkey with American Cheese on Focaccia roll" />
                            <asp:ListItem Text="Chicken Salad on Focaccia roll" Value="Chicken Salad on Focaccia roll" />
                            <asp:ListItem Text="Tuna Salad on Focaccia roll" Value="Tuna Salad on Focaccia roll" />
                            <asp:ListItem Text="Roasted Vegetables and Mozzarella Wrap" Value="Roasted Vegetables and Mozzarella Wrap" />
                        </asp:DropDownList>
                        <br><br>
                        <asp:Label ID="Label24" runat="server" AssociatedControlID="DDList_CheeseDay1" Text="Enter Special Instructions Here:"></asp:Label>
                        <br>
                        <asp:TextBox ID="DDList_CheeseDay1" class="form-control" runat="server" Rows="2" TextMode="MultiLine"></asp:TextBox>
                        <br>
                        <asp:Label ID="Label6" runat="server" AssociatedControlID="DDList_BeverageDay1" Text="Select beverage:"></asp:Label>
                        <br>
                        <asp:DropDownList ID="DDList_BeverageDay1" runat="server">
                            ...
                            <asp:ListItem Text="Lime Sparkling Water" Value="Lime Sparkling Water" />
                        </asp:DropDownList>
                            </div>
                    </div>
                </div>
			...
			<div class="row">
				<div class="col-lg-12">
				  <p class="tagline">NIH...Turning Discovery Into Health<sup>®</sup></p>
					<p class="update"><span class="bold">Last Updated:</span>May 30, 2019</p>
				</div> <!-- /.col-lg-12 -->
			</div> <!-- /.row -->
...
<script type="text/javascript">
     counter = function() {
        ...
        $('#wordCount').html(250-wordCount);
    };
    $(document).ready(function() {
        $('#TXT_Bio').change(counter);
        $('#TXT_Bio').keydown(counter);
        $('#TXT_Bio').keypress(counter);
        $('#TXT_Bio').keyup(counter);
        $('#TXT_Bio').blur(counter);
        $('#TXT_Bio').focus(counter);
        $('#LunchDay1Selection').css("display", "none");
        $('#LunchDay2Selection').css("display", "none");
    });

    $('input[type=radio][name=RDList_BoxLunchDay1]').change(function() {
        if (this.value == 'TRUE') {
            $('#LunchDay1Selection').css("display", "block");
        }
    ...
    $('input[type=radio][name=RDList_BoxLunchDay2]').change(function() {
        if (this.value == 'TRUE') {
            $('#LunchDay2Selection').css("display", "block");
        }
        else if (this.value == 'FALSE') {
            $('#LunchDay2Selection').css("display", "none");
        }
