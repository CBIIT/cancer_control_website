<%@ Page Language="VB" AutoEventWireup="false" CodeFile="index.aspx.vb" Inherits="IS_training_education_tidirc_application" %>
...
<meta name="author" content="National Cancer Institute, Division of Cancer Control and Population Science">
    <title>Multilevel Intervention Training Institute (MLTI) | DCCPS/NCI/NIH</title>
...
<div class="page-title">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h1>Multilevel Intervention Training Institute (MLTI)  Application</h1>
			</div> <!-- /.col-lg-12 -->
		</div> <!-- close /.row -->
	</div> <!-- close /.container -->
</div> <!-- /.page-title -->
	...
	<div class="row">
		<div class="col-lg-12">
              <ol class="breadcrumb">
                    ...
                    <li>Multilevel Intervention Training Institute (MLTI)</li>
              </ol>
		</div> <!-- /.col-lg-12 -->
	</div> <!-- close /.row -->
    <div class="row">
		<div class="col-sm-4"><img src="/images/HDRP-MLTI-Logo.png" class="img-responsive" alt=""/></div>
    </div>
    <div class="row">
		<div class="col-md-12">
			<p class="pull-right small">OMB No.: 0925-0740<br>
					  Expiration Date:&nbsp; 12/19/2020 </p>
			<p class="small" style="clear: both;"><em>Public reporting burden for this collection of information is estimated to average 10 minutes per response, including the time for reviewing instructions, searching existing data sources, gathering and maintaining the data needed, and completing and reviewing the collection of information. An agency may not conduct or sponsor, and a person is not required to respond to, a collection of information unless it displays a currently valid OMB control number. Send comments regarding this burden estimate or any other aspect of this collection of information, including suggestions for reducing this burden to: NIH, Project Clearance Branch, 6705 Rockledge Drive, MSC 7974, Bethesda, MD 20892-7974, ATTN: PRA (0925-0046). Do not return the completed form to this address.</em></p>
		</div>
				...
				<div class="row">
					<div class="col-md-12">
					  ...
					  <asp:DropDownList ID="TXT_InvestigatorLevel" class="form-control" runat="server">
						...
						<asp:Label ID="Label15" runat="server" AssociatedControlID="TXT_FieldOfExpertise" Text="Field of Expertise (e.g. cancer care delivery, internal medicine, oncology, palliative care, primary care, etc.)*"></asp:Label>
