...
Partial Class IS_training_education_tidirc_application
    ...
    Protected Sub CustomValidator1_ServerValidate(source As Object, args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles CustomValidator1.ServerValidate
        ...
        If UP_PersonalStatement_File.FileBytes.Length > 5242880 Then
            args.IsValid = False
        Else
            args.IsValid = True
        End If
    ...
    Protected Sub BTN_UploadClicked_Click(sender As Object, e As EventArgs) Handles BTN_UploadClicked.Click
        ...
        If Page.IsValid Then
            ...
            Dim CancerControlContinuum As String = AES_Encrypt(ClearXsideScriptingValue(TempString1))
            ...
            Dim Populations As String = AES_Encrypt(ClearXsideScriptingValue(TempString1))
            ...
            Dim Setting As String = AES_Encrypt(ClearXsideScriptingValue(TempString1))
            ...
            Dim Curriculum_ContentType As String = ""
            Dim Curriculum_Filename As String = AES_Encrypt(ClearXsideScriptingValue(""))
            Dim bytes_ConceptPaper_File As Byte() = {}
            Dim ConceptPaper_ContentType As String = ""
            Dim ConceptPaper_Filename As String = AES_Encrypt(ClearXsideScriptingValue(""))
            Dim bytes_LettersOfRec_File As Byte() = {}
            Dim LettersOfRec_ContentType As String = ""
            Dim LettersOfRec_Filename As String = AES_Encrypt(ClearXsideScriptingValue(""))
