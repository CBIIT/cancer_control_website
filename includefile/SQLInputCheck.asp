...
Function SQLInjectionPrevention2(strnewtext) 
...
'	End If	
	...
	SQLInjectionPrevention2 =stroutput
...
'"update", "create", "select", "begin","delete", "drop", "end",  "open",
'"table", "@"

BlackList = Array("--",  "/*", "*/", "@@",_
                  "char", "nchar", "varchar", "nvarchar",_
                  "alert", "alter",  "cast", "cursor",_
                  "declare",  "exec",_
