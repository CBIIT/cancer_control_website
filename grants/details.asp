...
<table width="752" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
	<p><img src="../images/banner_dccps.jpg" width="752" alt="Cancer Control and Population Sciences - NCI's bridge to public health research, practice and policy" height="60" border="0"><br><br></p></td>
  </tr>
</table>
<!--- End DCCPS banner --->
		  ...
		  <tr>
			...
			<table width="162" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF">
			  <tr>
			    <td width="7" align="left" valign="top" class="box-title"><img src="../images/spacer.gif" width="7" height="17"
 alt="" border="0"></td>
 				<td width="100%" valign="left" class="box-title"><a href="../current_research.html" class="dccps-home">Cancer Control Research Home</a></td>
			  </tr>
			  <tr>
			    <td valign="top" align="left" colspan="2"><img src="../images/spacer.gif" width="1" height="1" alt="" border="0"></td>
			  </tr>
...
strCategory = Request.QueryString("param")
...
cmd.CommandText = "dccps.cancercomm_pkg.GetCategoryList"
cmd.Parameters.Append cmd.CreateParameter("category", adVarchar, adParamInput, 25, strCategory)
cmd.Parameters.Append cmd.CreateParameter("value", adVarchar, adParamInput, 200, strValue)
set rst = cmd.Execute
%>
<table border="1" width="80%">
  <tr>
    <th>Principal Investigator, Institution</th>
    <th>Title, Mechanism, Grant Number</th>
    <th>Research Emphasis, Audience</th>
    <th>Media</th>
  </tr>
<%
Set rst = cmd.Execute
...
%>
    <tr>
      <td><%=rst("last_name") & ", " & rst("first_name") & " " & rst("mi_name")%><br>
          <%=rst("org_name")%>
      </td>
      <td><a href="/grants/abstract.asp?ApplId=<%=rst("appl_id")%>"><%=rst("project_title")%></a><br>
          <%=rst("activity_code") & " " & rst("admin_phs_org_code") & rst("serial_num")%>
      </td>
      <td><%=rst("research_emphasis")%><br>
          <%=rst("audience")%>
      </td>
      <td><%=rst("media")%></td>
    </tr>
