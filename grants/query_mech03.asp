...
<html>
<head>
<title>DCCPS: Cancer Control Research</title>
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preload../images('../images/arrow_red.gif')">
<!--- Cancer.gov banner --->
...
<table width="752" border="0" cellpadding="0" cellspacing="0">
 ...
 alt="" border="0"></td>
		...
		<table width="159" cellspacing="0" cellpadding="1" border="0" class="gray-border">
		  <tr>
			...
			<table width="159" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF">
		      ...
		      <tr>
		        <td valign="top" align="left" colspan="3"><img src="../images/spacer.gif" width="7" height="17" alt="" border="0"></td>
              </tr>
		      <tr>
   ...
   ' strBranch can be either an abbreviation or a branch ID.
...
<%
        ...
        ' If abbreviations are used, a program and branch must
        ' be specified.  If IDs are used, a branch ID is sufficient.
        If vbNullString = strProgram and vbNullString = strBranch Then
        ...
        Else
            If vbNullString = strBranch  Then
				...
				If ValidateStringParameter(strProgramMessage, strProgram) = 0 Then 'if strProgram is valid, display prgram name
					Response.write GetProgramName(strProgram) 
				Else 'if strProgram is invalid, display error
					Response.write ValidateStringParameter(strProgramMessage, strProgram)
				End If
    	    Else
    	        If IsNumeric(strBranch) Then
    	            Response.write GetBranchNameFromId(strBranch) & ": "
    	        Else
        	    	'Response.write GetBranchName(strProgram, strBranch) & ": "
					'if both strProgram and strBranch are valid, display prgram name and branch name
					If ValidateStringParameter(strProgramMessage, strProgram) = 0 AND ValidateBranch(strBranchMessage, strBranch) = 0 Then
						Response.write GetBranchName(strProgram, strBranch) & ": "
					Else 'if strBranch is invalid, display error
...
<%
    	If vbNullString <> strMechanism Then
			...
			If ValidateStringParameter(strMechanismMessage, strMechanism) = 0 Then 'if strMechanism is valid, display mechTitle
			   strMechanismTitle = GetMechTitle(strMechanism)
			Else 'if strMechanism is invalid, display Error
...
<p>This list contains active small grants carried over from prior fiscal years and new grants awarded in the current fiscal year. Refer to the DCCPS Small Grants Web site for detailed information about the small grants program, <a href="http://cancercontrol.cancer.gov/smallgrants/">http://cancercontrol.cancer.gov/smallgrants/</a></p>
<%
  End If
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<p><a href="search.html" class="gray-link">Search</a> | <a href="../help.html" class="gray-link">Help</a> | <a href="../contact.html" class="gray-link">Contact Us</a> | <a href="http://www3.cancer.gov/accessibility/nci508.htm" class="gray-link">Accessibility</a>  | <a href="../privacy-policy.html" class="gray-link">Privacy Policy</a></p>
...
<%' Validate an integer value
	...
	Function ValidateStringParameter(strMessage, strParameter)
            ...
            ' Validate
            strResult = ValidateString(strParameter, 3, vbNull, vbNull)
